...
#   function() {
#     to_load <- microbiomeplot_core_unloaded()
#     if (length(to_load) == 0)
#       return(invisible())
#     
#     msg(cli::rule(
...
#       right = paste0(
#         "microbiomeplot ",
#         microbiomeplot_package_version("microbiomeplot")
#       )
#     ),
#     startup = TRUE)
#     
#     versions <-
#       vapply(to_load, microbiomeplot_package_version, character(1))
#     packages <- paste0(
...
#   }
# 
# microbiomeplot_package_version <- function(x) {
